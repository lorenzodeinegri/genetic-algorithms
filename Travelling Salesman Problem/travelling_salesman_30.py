...
def get_cities():
    ...
    capital_cities = capital_cities[:30]
...
def genetic_algorithm(generations, population, elit, studEA, types):
    ...
    plot_algorithm_progress(np.array(model.report), '30_Convergence_' + types + '.png')
    plot_algorithm_generation(model.output_dict['last_generation']['scores'], '30_Scores_' + types + '.png')
    print_algorithm_solution(model.output_dict['variable'], model.output_dict['function'])
    plot_map(model.output_dict['variable'], '30_' + types)
