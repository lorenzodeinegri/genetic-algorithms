...
def genetic_algorithm(generations, population, elit, studEA, types):
    ...
    plot_algorithm_progress(np.array(model.report), '24_Convergence_' + types + '.png')
    plot_algorithm_generation(model.output_dict['last_generation']['scores'], '24_Scores_' + types + '.png')
